    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "variables_help",
                    models.TextField(help_text="Available template variables"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "attempt_number",
                    models.IntegerField(
                        default=1, help_text="1st, 2nd, or 3rd attempt"
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Message Subject id we use to track the email",
                        max_length=200,
                    ),
                ),
                (
                    "attachments_sent",
                    models.JSONField(
                        default=list, help_text="List of attachment file names"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
